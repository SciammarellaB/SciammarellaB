# Olá, eu sou Brenno Sciammarella 👋

Sou desenvolvedor Full Stack e bacharel em Engenharia da Computação.

Meu foco profissional está no desenvolvimento de aplicações com **C#/.NET**, incluindo **APIs RESTful**, regras de negócio, integrações e bancos de dados. No front-end, trabalho com **Angular**, **Vue.js**, **Ionic** e **TypeScript**.

Também utilizo este espaço para estudos e projetos pessoais envolvendo inteligência artificial, sistemas embarcados, linguagem C e impressão 3D.
...
- Impressão 3D e projetos maker
- Desenvolvimento de jogos e computação gráfica

## 📫 Contato

<div align="left">
  <a href="https://www.linkedin.com/in/brenno-de-carvalho-prado-frangella-sciammarella-91a43a140/">
